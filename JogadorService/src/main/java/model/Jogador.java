...
public class Jogador 
{
	...
	public Jogador( int codigo, String login, String senha, char sexo ) 
	{
		setCodigo( codigo );
		setLogin ( login  );
		setSenha ( senha  );
	...
	// Construtor Alternativo
	public Jogador( String login, String senha, char sexo ) 
	{
		setLogin ( login  );
		setSenha ( senha  );
		setSexo  ( sexo   );
	...
	{
		return (this.getCodigo() == ((Jogador) obj).getCodigo());
	} // end equals ( )	
} // end class
